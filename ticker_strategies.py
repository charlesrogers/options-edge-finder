...
TICKER_STRATEGIES = {
    'TMUS': {
        ...
        'expected_trades': 46,
        'note': 'Exp 013: 3% too aggressive (28% loss rate). 10% OTM: 89% win, 11% loss.',
    },
    'KKR': {
        'otm_pct': 0.15,
        'min_dte': 20,
        ...
        'tier': 'good',
        'expected_pnl': 386,
        'expected_win_rate': 87,
        'expected_trades': 46,
        'note': 'Exp 013: 3% too close (30% loss). 15% OTM: 87% win, 13% loss.',
    },
    'DIS': {
        'otm_pct': 0.07,
        'min_dte': 30,
    ...
    'GOOGL': {
        ...
        'expected_win_rate': 0,
        'expected_trades': 65,
        'note': 'Exp 013: 48% loss rate at 5% OTM. Rallied 73% in 1yr. Even 20% OTM loses 15%. Skip.',
    },
    'AMZN': {
        'otm_pct': 0.05,
        'min_dte': 20,
